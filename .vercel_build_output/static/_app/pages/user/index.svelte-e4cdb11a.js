...
function u(s) {
	...
	return {
		...
		l(s) {
			e = c(s, 'DIV', { class: !0 });
			var a = o(e);
			(l = c(a, 'IMG', { alt: !0, src: !0, class: !0 })),
				(w = A(a)),
				(p = c(a, 'DIV', { class: !0 }));
			var t = o(p);
			u = c(t, 'SPAN', { class: !0 });
			var r = o(u);
			(v = m(r, 'Amahoro')), r.forEach(x), (g = A(t)), (I = c(t, 'SPAN', { class: !0 }));
			var d = o(I);
			(b = m(d, '22 December 2020')),
				d.forEach(x),
				t.forEach(x),
				(V = A(a)),
				a.forEach(x),
		...
		h() {
			d(l, 'alt', 'Success Kid'),
				l.src !== (f = E) && d(l, 'src', f),
				d(l, 'class', 'h-10 w-10 rounded-full cursor-pointer svelte-1h36ws9'),
				d(u, 'class', 'font-semibold text-sm svelte-1h36ws9'),
				d(I, 'class', 'text-gray-500 text-sm svelte-1h36ws9'),
				d(p, 'class', 'flex flex-col pl-2 svelte-1h36ws9'),
				d(
					e,
					'class',
					'mb-0 px-3 pb-1 md:px-6 flex cursor-pointer rounded items-center mx-auto svelte-1h36ws9'
				);
		},
		m(s, a) {
			i(s, e, a), h(e, l), h(e, w), h(e, p), h(p, u), h(u, v), h(p, g), h(p, I), h(I, b), h(e, V);
		},
		p: n,
		d(s) {
			s && x(e);
...
function v(s) {
	let e,
		...
		Is = s[0],
		bs = [];
	for (let a = 0; a < Is.length; a += 1) bs[a] = u(p(s, Is, a));
	return {
		c() {
			(e = t()),
				(l = a('div')),
				...
				(Es = t()),
				(gs = a('div'));
			for (let s = 0; s < bs.length; s += 1) bs[s].c();
			this.h();
		},
		l(s) {
			f('[data-svelte="svelte-fpw0lw"]', document.head).forEach(x),
				(e = A(s)),
				(l = c(s, 'DIV', { class: !0 }));
			var a = o(l);
			v = c(a, 'DIV', { class: !0 });
			...
			g = c(r, 'H1', { class: !0 });
			var d = o(g);
			(I = m(d, 'Welcome Makuza Verite')),
				d.forEach(x),
				(b = A(r)),
				(V = c(r, 'H3', { class: !0 }));
			var i = o(V);
			(D = m(i, 'Have a nice day !')),
				i.forEach(x),
				r.forEach(x),
				t.forEach(x),
				(Q = A(a)),
			...
			(Z = c(Ds, 'DIV', { class: !0 })),
				...
				(W = c(Ds, 'P', { class: !0 }));
			var Qs = o(W);
			(X = m(Qs, 'Gorillas Found')), Qs.forEach(x), (O = A(Ds)), (C = c(Ds, 'H4', { class: !0 }));
			var Js = o(C);
			(F = m(Js, '136')),
				Js.forEach(x),
				Ds.forEach(x),
			...
			(as = c(Ms, 'DIV', { class: !0 })),
				...
				(rs = c(Ms, 'P', { class: !0 }));
			var Ps = o(rs);
			(cs = m(Ps, 'Gorillas Lost')), Ps.forEach(x), (os = A(Ms)), (As = c(Ms, 'H4', { class: !0 }));
			var js = o(As);
			(ms = m(js, '9')),
				js.forEach(x),
				Ms.forEach(x),
			...
			ns = c(Ts, 'H3', { class: !0 });
			var ks = o(ns);
			(fs = m(ks, 'Gorillas List')),
				ks.forEach(x),
				(ws = A(Ts)),
				(ps = c(Ts, 'A', { href: !0, class: !0 }));
			var ys = o(ps);
			us = c(ys, 'H3', { class: !0 });
			var Zs = o(us);
			(vs = m(Zs, 'View all')),
				...
				(gs = c(Gs, 'DIV', { class: !0 }));
			var Hs = o(gs);
			for (let e = 0; e < bs.length; e += 1) bs[e].l(Hs);
			Hs.forEach(x), Gs.forEach(x), Ss.forEach(x), h.forEach(x), a.forEach(x), this.h();
		},
		h() {
			(document.title = 'WELCOME'),
				d(g, 'class', 'text-white text-2xl font-semibold mb-2 ml-2 md:ml-5 svelte-1h36ws9'),
				d(V, 'class', 'text-white text-xl ml-2 md:ml-5 svelte-1h36ws9'),
				d(E, 'class', 'px:2 m-2 md: bg-primaryGreen rounded-xl p-3 px-5 md:py-6 svelte-1h36ws9'),
				d(
					v,
					'class',
					'rounded px-4 pt-3 pb-1 md:px-8 md:py-3 mr-3 flex flex-col md:w-11/12 longer py-6 sm:w-full md:w-full lg:w-11/12 svelte-1h36ws9'
				),
				d(R, 'class', 'font-semibold text-xl mx-6 svelte-1h36ws9'),
				d(S, 'class', 'font-semibold full md:mr-10 svelte-1h36ws9'),
				d(j, 'href', '/admin/reports'),
				d(j, 'class', 'svelte-1h36ws9'),
				d(B, 'class', 'flex w-full justify-between mb-4 svelte-1h36ws9'),
				d(Z, 'class', 'h-32 w-24 rounded-xl attended svelte-1h36ws9'),
				d(W, 'class', 'text-xs text-gray-600 mt-2 svelte-1h36ws9'),
				d(C, 'class', 'text-2xl font-semibold mt-2 svelte-1h36ws9'),
				d(
					y,
					'class',
					'mt-4 md:mt-0 nw-3/10 flex flex-col items-center bg-white py-2 md:pb-6 md:pt-3 px-4 rounded-xl mx-2 cursor-pointer svelte-1h36ws9'
				),
				d(U, 'class', 'h-32 w-24 rounded-xl made svelte-1h36ws9'),
				d(K, 'class', 'text-xs text-gray-600 mt-2 svelte-1h36ws9'),
				d(_, 'class', 'text-2xl font-semibold mt-2 svelte-1h36ws9'),
				d(
					L,
					'class',
					'mt-4 md:mt-0 w-3/10 flex flex-col items-center bg-white py-2 md:pb-6 md:pt-3 px-4 rounded-xl mx-2 cursor-pointer svelte-1h36ws9'
				),
				d(as, 'class', 'h-32 w-24 rounded-xl attended missed svelte-1h36ws9'),
				d(rs, 'class', 'text-xs text-gray-600 mt-2  svelte-1h36ws9'),
				d(As, 'class', 'text-2xl font-semibold mt-2 svelte-1h36ws9'),
				d(
					ls,
					'class',
					'mt-4 md:mt-0 w-3/10 flex flex-col items-center bg-white py-2 md:pb-6 md:pt-3 px-4 rounded-xl mx-2 cursor-pointer svelte-1h36ws9'
				),
				d(k, 'class', 'w-full flex flex-wrap justify-between svelte-1h36ws9'),
				d(N, 'class', 'md:w-8/12 px-5 mt-10 svelte-1h36ws9'),
				d(ns, 'class', 'font-semibold text-xl mx-4 svelte-1h36ws9'),
				d(us, 'class', 'font-semibold text-sm full mx-4 svelte-1h36ws9'),
				d(ps, 'href', '/admin/gorillas'),
				d(ps, 'class', 'svelte-1h36ws9'),
				d(hs, 'class', 'flex justify-between mb-1 svelte-1h36ws9'),
				d(gs, 'class', ' svelte-1h36ws9'),
				d(is, 'class', 'bg-white flex flex-col pt-3 px-3 rounded-lg w-11/12 svelte-1h36ws9'),
				d(ds, 'class', 'sm:w-full md:w-4/12 lg:w-5/12 px-5 md:px-1 mt-6 md:mt-0 svelte-1h36ws9'),
				d(J, 'class', 'w-full md:flex  px-4 sm:w-full md:w-full lg:w-11/12 svelte-1h36ws9'),
				d(l, 'class', 'svelte-1h36ws9');
		},
		m(s, a) {
			i(s, e, a),
				i(s, l, a),
				...
				h(is, Es),
				h(is, gs);
			for (let e = 0; e < bs.length; e += 1) bs[e].m(gs, null);
		},
		p(s, [e]) {
			if (0 & e) {
				let l;
				for (Is = s[0], l = 0; l < Is.length; l += 1) {
					const a = p(s, Is, l);
					bs[l] ? bs[l].p(a, e) : ((bs[l] = u()), bs[l].c(), bs[l].m(gs, null));
				}
				for (; l < bs.length; l += 1) bs[l].d(1);
				bs.length = Is.length;
			}
		},
		i: n,
