...
const X = {},
	...
	H = [
		() =>
			F(() => import('./pages/$layout.svelte-77147f15.js'), [
				'/_app/pages/$layout.svelte-77147f15.js',
		...
		() => F(() => import('./pages/auth/login.svelte-6cf9d2e1.js'), void 0),
		() =>
		...
		() =>
			F(() => import('./pages/user/settings.svelte-84a41692.js'), [
