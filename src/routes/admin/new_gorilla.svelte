...
<form class="md:flex" on:submit|preventDefault="{handleOnSubmit}">
	...
	<div class="w-full md:w-8/12 max-w-sm overflow-hidden space-y-6 mt-3 md:-mt-10">
		...
		<div class="border-b-2 focus-within:border-green-500 flex">
			...
			<input type="date"  placeholder="" bind:value={gorilla.dob} class="px-4 block w-full appearance-none focus:outline-none bg-transparent" />
		</div>
		<div class="border-b-2 focus-within:border-green-500 flex">
			<label for="name" class="px-2">Mother:</label>
			<select  bind:value={gorilla.mother} class="px-4 block w-full appearance-none focus:outline-none bg-transparent">
		...
		<div class="border-b-2 focus-within:border-green-500 flex">
			...
			<select bind:value={gorilla.father} class="px-4 block w-full appearance-none focus:outline-none bg-transparent">
		...
		<div class="border-b-2 focus-within:border-green-500 flex">
			...
			<select bind:value={gorilla.family} class="px-4 block w-full appearance-none focus:outline-none bg-transparent">
		...
		<div class="border-b-2 focus-within:border-green-500 flex">
			...
			<select bind:value={gorilla.gender} class="px-4 block w-full appearance-none focus:outline-none bg-transparent">
