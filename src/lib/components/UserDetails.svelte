		...
		<div class="md:flex">
			<div class="w-full md:w-6/12 flex flex-col items-center mx-auto">
				<div class="flex flex-col items-center mx-auto">
					<h3
						class="font-bold text-xl text-greenAccent mb-3 border-b-2 border-green-700 cursor-pointer"
					>
						Verite Address
					</h3>
				</div>
			...
			<div class="w-full md:w-6/12 flex flex-col">
				<div class="w-full">
					<div class="flex flex-col items-center mx-auto">
						<h3
							class="text-xl font-bold text-greenAccent mb-4 border-b-2 border-green-700 cursor-pointer"
						>
							Verite Stats
						</h3>
					</div>
					<div class="flex w-full">
						<div
							class="w-4/12 flex flex-col items-center  py-4 hover:shadow-lg rounded cursor-pointer mx-2"
						>
						...
						<div
							class="w-4/12 flex flex-col items-center mx-2 py-4 hover:shadow-lg rounded cursor-pointer"
						>
